...
export class Tree extends GameObject {
  ...
  step(delta, root) {
    ...
    const randomOffsetX = randomInt(0, this.radius * 2) * (randomInt(0, 1) === 0 ? -1 : 1); // Random offset for X
    const randomOffsetY = randomInt(0, this.radius * 2) * (randomInt(0, 1) === 0 ? -1 : 1); // Random offset for Y
